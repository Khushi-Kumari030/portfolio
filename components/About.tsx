...
import { GraduationCap, BrainCircuit, Code, BookOpen, Award } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div>
            <div className="inline-flex items-center gap-2 mb-3">
              ...
              <span className="text-xs font-mono text-[#F29B70] uppercase tracking-widest">ABOUT</span>
            </div>
          ...
          <p className="text-sm font-sans text-[#A8A098] max-w-md leading-relaxed">
            Synthesizing machine intelligence, perceptual computer vision, and robust software architecture.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
          ...
          >
            ...
            {/* BlackRock Opportunity Card (Clean presentation without UPCOMING badges) */}
            <div className="p-5 rounded-2xl bg-[#151412] border border-[#FF6B35]/50 relative overflow-hidden shadow-[0_0_20px_rgba(255,107,53,0.1)]">
              <h3 className="font-serif text-lg sm:text-xl font-bold text-[#F5EFE6]">
                {siteConfig.upcomingOpportunity.role} — <span className="text-[#FF6B35]">{siteConfig.upcomingOpportunity.company}</span>
              </h3>
              <p className="text-xs sm:text-sm text-[#A8A098] font-sans mt-1.5 leading-relaxed">
                {siteConfig.upcomingOpportunity.note}
              </p>
            </div>
          ...
          >
            <div className="p-7 rounded-2xl bg-[#151412] border border-[#292521] space-y-5">
              <div className="flex items-center gap-3 pb-3 border-b border-[#292521]">
                ...
                <div>
                  <h3 className="font-serif text-lg font-bold text-[#F5EFE6]">Education &amp; Qualifications</h3>
                  <p className="text-xs font-mono text-[#A8A098]">IIT Kharagpur &amp; Credentials</p>
                </div>
              </div>
              ...
              {/* GATE Qualification Badge */}
              <div className="p-3.5 rounded-xl bg-[#0B0B0A] border border-[#FF6B35]/40 flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  <Award className="w-4 h-4 text-[#FF6B35]" />
                  <div>
                    <span className="text-xs font-mono font-medium text-[#F5EFE6] block">GATE Civil Engineering</span>
                    <span className="text-[11px] text-[#A8A098]">National Competitive Qualification</span>
                  </div>
                </div>
                <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-[#151412] text-[#FF6B35] border border-[#FF6B35]/50 font-bold">
                  Qualified
                </span>
              </div>
